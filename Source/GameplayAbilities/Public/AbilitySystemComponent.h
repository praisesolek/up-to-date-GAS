...
class GAMEPLAYABILITIES_API UAbilitySystemComponent : public UGameplayTasksComponent, public IGameplayTagAssetInterface, public IAbilitySystemReplicationProxyInterface
{
	...
	void GetAllAttributes(TArray<FGameplayAttribute>& Attributes);
	 ...
	 * @param bFound Set to true if the attribute exists on this component
	 */
	UFUNCTION(BlueprintPure, Category = "Gameplay Attributes")
	 ...
	 *	Tags added this way are not replicated! Use the 'Replicated' versions of these functios if replication is needed.
